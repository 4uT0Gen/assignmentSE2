...
<div id="contact-page">
    <div class="bg container col-sm-12" >
          ...
          <section class="col-sm-12" style="margin-bottom: 30px">
                    ...
                    <p>Làm thế nào để có thể chọn được những cuốn <strong> Sách cực hay và </strong>thật chất chơi đời sống tinh thần của ta?<p>
        ...
        <div class="col-sm-4">
            <div class="contact-info">
                ...
                <address>
                    <p>Nhà sách HANU</p>
                    <p>Nguyễn Trãi, Thanh Xuân</p>
                    <p>Hà Nội</p>
                    <p>Student ID: 1801040135</p>
                    <p>Student ID: 1801040103</p>
                    <p>Email: hanu@gmail.com</p>
                </address>
    ...
    <script>
        $(document).ready(function () {
            $(".gui_mail").click(function () {
                ...
                if (mk == "" || email == "" || text == "" || oj == "")
                {
                    $('.thongBao').html("Nhập đầy đủ thông tin!").css("color", "#700404");
                    return;
                } else
                {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data == 1) {
                                $('.thongBao').html("Email được gửi thành công !").css("color", "#700404");
                                $(".text-mail").val("");
                                $(".chu_de-mail").val("");
                            } else
                            {

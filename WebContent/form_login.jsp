        ...
        <script>
            $(document).ready(function () {
                ...
                $(".dnn").click(function () {
                    ...
                    if (t == "" || m == "")
                    {
                        $(".thong_bao1").html("Nhập đầy đủ thông tin!").css("color", "#700404");
                        return;
                    } else
                    {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                {
                                    $(".matKhau").val("");
                                    $(".thong_bao1").html("Đăng nhập lại!").css("color", "#700404");
                                    return;
                                }
                            }
                        });
                ...
                $('.dkk').click(function () {
                    ...
                    {
                        $(".thong_bao2").html("Nhập đầy đủ thông tin !").css("color", "#700404");
                        return;
                    } else
                    {
                        ...
                        {
                            $(".thong_bao2").html("Email không hợp lệ !").css("color", "#700404");
                            $(".email_dkk").val("");
                            return;
                        }
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                {
                                    $(".thong_bao1").html("Thất bại !").css("color", "#700404");
                                    return;
                                }
                            }
                        });

                        ...
                        <div class="col-sm-4">
                            <div class="shopper-info">
                                ...
                                <form>
                                    ...
                                    <div class="haha">
                                        <div>Chủ tài khoản: Nhà sách <strong>HANU</strong></div>
                                        <div>Số tài khoản: 9999 9999 9999, Ngân hàng BIDV</div>
                                        <div>Mọi thắc mắc vui lòng <b><a href="#" style="color: #700404" class="lh">liên hệ</a></b> tới nhà sách. Chúng tôi có giải đáp hay không kệ bạn!</div>
                                    </div>
        ...
        <section id="ok" style="margin-top: 70px">
            <div class="container">
                <center>
                    ...
                    <h5 style="display: inline">Cảm ơn bạn đã đặt hàng & sử dụng dịch vụ tại nhà sách HANU!</h5>
                    ...
                    <div class="customer-care-info">
                        <p>Thông tin đặt hàng của bạn tại <strong>sachhanuvip.com</strong> đã được ghi nhận. Nhân viên sẽ liên lạc với bạn trong thời gian sớm nhất.</p>
                        <p>Nếu có bất kì điều gì thắc mắc, xin hãy gọi cho chúng tôi:<span class="hotline">1900 99999</span> (8h-23h, T7-CN)</p>
                        <p>Hoặc gửi email tới: hanu@gmail.com .</p>
                    </div>
